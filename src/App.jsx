...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#030304] text-white relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[550px] opacity-60">
      ...
      <section id="home" className="relative min-h-screen flex flex-col items-center justify-center pt-32 px-4 text-center overflow-hidden z-10">
        <div className="max-w-5xl">
          ...
          {/* Buttons styled exact to reference */}
          <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
            <motion.a
              whileHover={{ scale: 1.05, boxShadow: "0 0 30px rgba(255, 255, 255, 0.4)" }}
              whileTap={{ scale: 0.96 }}
              href="#projects"
              className="px-8 py-3.5 rounded-full bg-white text-black font-semibold text-sm flex items-center gap-2 transition-all duration-200"
            >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.96 }}
              href="#contact"
              className="px-8 py-3.5 rounded-full border border-white/20 text-white font-medium text-sm transition-all duration-200 bg-white/5"
            >
              Contact Me
            </motion.a>
          </div>
      ...
      <section id="contact" className="max-w-2xl mx-auto px-4 py-24 text-center z-10 relative">
        <PremiumCard>
          ...
          <motion.a
            whileHover={{ scale: 1.05, boxShadow: "0 0 35px rgba(255, 255, 255, 0.35)" }}
            whileTap={{ scale: 0.96 }}
            href={`mailto:${portfolioData.email}`}
            className="inline-flex items-center gap-2 px-9 py-4 rounded-full bg-white text-black font-semibold text-sm transition-all"
          >
